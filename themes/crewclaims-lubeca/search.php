        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-9 col-12-medium">
                    ...
                    <h2 class="search-title-heading">Search Results</h2>
                    <div class="border-line"></div>
                    <h3 class="search-title-sub-heading">You Search for "<?php echo esc_html( get_search_query(false) ); ?>"</h3>
                        ...
                        <?php } else { ?>
                            ...
                            <div class="post format-standard-image">
                                    <div class="entry-details">
                                        ...
                                        <a href="<?php echo esc_url(site_url('/news'));  ?>" class="read-more">Go Back to News & Publication <i class="fi ti-angle-right"></i></a>
                                    </div>
                                </div>
